...
if 'transitionRisk,evidenceIndependence,evidenceCompleteness,scenarioRobustness:scenario' not in text:
    text=replace_once(text,
        'transitionRisk,evidenceIndependence,scenarioRobustness:scenario',
        'transitionRisk,evidenceIndependence,evidenceCompleteness,scenarioRobustness:scenario',
        'evidence completeness pair output')
...
if principle not in text:
    marker="'cross-asset confirmation uses independent dollar, rates, equity, volatility and gold transmission rather than duplicating pair momentum'"
    text=replace_once(text,marker,marker+','+principle,'evidence completeness principle')
path.write_text(text,encoding='utf-8')
print('Evidence completeness governance v2 applied.')
