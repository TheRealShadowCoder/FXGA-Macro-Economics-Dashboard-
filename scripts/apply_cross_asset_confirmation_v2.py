...
if 'expectationGap,marketSignal,crossAsset,contradictions' not in text:
    text=replace_once(text,'expectationGap,marketSignal,contradictions','expectationGap,marketSignal,crossAsset,contradictions','expose cross-asset pair field')
...
print('Robust cross-asset confirmation v2 applied.')
